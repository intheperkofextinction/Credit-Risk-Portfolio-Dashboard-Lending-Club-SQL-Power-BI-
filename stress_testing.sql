...
--
-- Description:
-- This SQL query performs a simple credit risk stress test
-- on the lending portfolio to estimate how expected losses
-- would change under a deterioration in borrower credit
-- quality.
--
-- The analysis first calculates baseline credit risk
-- parameters using the loans_clean dataset:
--
...
--
-- The query then simulates a stress scenario by increasing
-- the Probability of Default by 3 percentage points. This
-- represents a potential economic downturn or worsening
-- borrower credit conditions.
--
...
--
-- This type of stress testing is commonly used in financial
-- risk management to evaluate how sensitive a lending
-- portfolio is to worsening economic conditions and to help
-- institutions plan capital buffers for potential losses.
-- ============================================================
